...
function catppuccin.select(palette)
	...
	local isPiccolo = palette == "piccolo"
	...
	return {
		...
		cursor_fg = (isLatte or isPiccolo) and colors[palette].base or colors[palette].crust,
		selection_bg = colors[palette].surface2,
		selection_fg = colors[palette].text,
		ansi = {
			(isLatte or isPiccolo) and colors[palette].subtext1 or colors[palette].surface1,
			colors[palette].red,
			...
			colors[palette].pink,
			colors[palette].teal,
			(isLatte or isPiccolo) and colors[palette].surface2 or colors[palette].subtext1,
		},
		brights = {
			(isLatte or isPiccolo) and colors[palette].subtext0 or colors[palette].surface2,
			colors[palette].red,
			colors[palette].green,
			colors[palette].yellow,
			colors[palette].blue,
			colors[palette].pink,
			colors[palette].teal,
			(isLatte or isPiccolo) and colors[palette].surface1 or colors[palette].subtext0,
		},
		tab_bar = {
